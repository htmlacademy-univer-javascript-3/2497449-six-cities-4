...
export default function OfferScreen({ offers, reviews }: OfferScreenProps): JSX.Element {
  const {id} = useParams();
  const [{isFavorite, isPremium, numOfBedrooms, maxNumOfGuests, description, rating, price, title, type, autor}] = offers.filter((offer) => offer.id.toString() === id);
        ...
        <div className ="container">
          <section className ="near-places places">
            ...
            <div className ="near-places__list places__list">
              <CardsList isMainScreen = {false} offers={offers.slice(0,3)} setActiveCard={setActiveCard}/>
            </div>
          </section>
        </div>
      </main>
